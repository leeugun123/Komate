...
class BoardActivity : AppCompatActivity() {
    ...
    private fun showReportDialog() {
        ...
        builder.setPositiveButton("확인") { _, _ ->
            ...
            Firebase.database.reference.child("postReports").child(Firebase.database.reference.push().key.toString()).setValue(
                Report(userId,selectedReasons,receiveData?.userId,receiveData?.postId)
            )
            //신고 넣기
